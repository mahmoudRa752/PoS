...
<head>
  ...
  @if (app()->getlocale()=='ar')
    ...
    <link rel="stylesheet" href="{{asset('dashboard/css/rtl/bootstrap-rtl.css')}}">
    <link rel="stylesheet" href="{{asset('dashboard/css/adminlte.css')}}">
    <link rel="stylesheet" href="{{asset('dashboard/css/rtl/AdminLTE-rtl.css')}}">
    <style>
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        <a href="" class="nav-link"><i class="far fa-circle nav-icon"></i></a>
        <!-- <ul class="menu">
